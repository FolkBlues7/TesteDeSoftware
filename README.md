# TesteDeSoftware
Repositório dedicado ao arquivamente do(s) software(s) criado(s) na Disciplina de Teste de Software. Ciência da Computação - UFERSA
...
🚀 Funcionalidades
    ...
    Garantia de Acessibilidade: O sistema utiliza um algoritmo de busca (BFS) para garantir que todas as moedas sejam alcançáveis.
...
Para garantir que todos os requisitos da especificação foram atendidos, o projeto segue a seguinte matriz:
...
O relatório do JaCoCo estará disponível em: target/site/jacoco/index.html
📝 Detalhes Técnicos de Implementação

O projeto utiliza o padrão Strategy para a geração de números aleatórios (RandomGenerator), permitindo que nos testes de unidade possamos "mockar" ou predefinir comportamentos aleatórios, garantindo que os testes sejam determinísticos mesmo em um jogo procedimental.
